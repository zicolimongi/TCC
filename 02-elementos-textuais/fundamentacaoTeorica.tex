...
Outra razão para utilizar agregação é que isso facilita o uso do banco de dados em \textit{clusters}, pois isso informa ao sistema, quais \textit{bits} dos dados devem ser manipulados juntos e se devem estar no mesmo nó do \{cluster}.
